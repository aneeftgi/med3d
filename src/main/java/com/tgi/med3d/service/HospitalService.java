...
//			List<HospitalResponseDto> hospitalResponseDtoList = new ArrayList<HospitalResponseDto>();
//			hospitalDetailsList.forEach(hm -> {
//				hospitalResponseDtoList.add(convertHospitalEntityToDto(hm));
//			});
